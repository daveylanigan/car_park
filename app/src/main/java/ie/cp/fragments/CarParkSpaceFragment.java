 ...
 ////       carParkFilter = new CarParkFilter(activity.app.dbManager, listAdapter);
    ...
    public void onCarParkSpaceDelete(final CarParkSpace carParkSpace)
    {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener()
        {
            ...
            {
                activity.app.dbManager.deleteCarParkSpace(carParkSpace.carParkSpaceId); // remove from our list
    ...
    public void deleteCarParkSpace(ActionMode actionMode)
    {
        ...
        for (int i = listAdapter.getCount() - 1; i >= 0; i--)
            if (listView.isItemChecked(i))
                activity.app.dbManager.deleteCarParkSpace(listAdapter.getItem(i).carParkSpaceId); //delete from DB
